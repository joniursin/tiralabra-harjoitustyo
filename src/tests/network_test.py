...
class TestNetwork(unittest.TestCase):
    ...
    def test_feedforward_values(self):
        self.network.weights = [np.array([[0.1, 0.2], [0.3, 0.4]]), np.array([[0.5, 0.6]])]
    ...
    def test_backpropagation_values(self):
        ...
        biases = [np.array([[0.10154455], [0.20154455]]), np.array([[0.3057481]])]
        weights = [np.array([[0.10014254, 0.20021382], [0.30016636, 0.40024955]]), np.array([[0.50313202, 0.60341364]])]
